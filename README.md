...
UI 层（极简）
    ↓
本地控制层（核心）
    ├── AuthManager      # OAuth2 认证
    ├── ConfigManager    # 配置拉取/缓存
...
| 端点 | 方法 | 描述 |
|------|------|------|
| `/api/v1/auth/login` | GET | OAuth2 登录入口 |
| `/api/v1/auth/callback` | POST | OAuth2 回调 |
